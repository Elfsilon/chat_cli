...
import (
	...
	"server/internal/chat/gen/ent/migrate"
...
func (c *ChatClient) QueryChatMessage(ch *Chat) *ChatMessageQuery {
...
func (c *ChatMessageClient) QueryOwner(cm *ChatMessage) *ChatQuery {
